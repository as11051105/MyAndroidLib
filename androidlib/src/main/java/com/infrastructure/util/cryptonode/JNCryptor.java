 ...
 * <p>
 * See
 * <a href="https://github.com/rnapier/RNCryptor">https://github.com/rnapier/
...
public interface JNCryptor {
     ...
     *
     * @param password password to use for PBKDF. Cannot be empty or
     *                 <code>null</code>.
     * @param salt     salt for password, cannot be <code>null</code>
     * @return the key
     */
     ...
     * @param encryptionKey the pre-computed encryption key
     * @param hmacKey       the pre-computer HMAC key
     ...
     * >https://github.com/RNCryptor/RNCryptor-Spec/blob/master/
     * RNCryptor- Spec-v3.md</a>
     * @since 1.2.0
     */
     ...
     * @param password       the password (cannot be <code>null</code> or empty)
     * @param encryptionSalt eight bytes of random salt value
     * @param hmacSalt       eight bytes of random salt value
     * @param iv             sixteen byte AES IV
     * @return the ciphertext, in the format described at <a href=
     * "https://github.com/RNCryptor/RNCryptor-Spec/blob/master/RNCryptor-Spec-v3.md"
     * >https://github.com/RNCryptor/RNCryptor-Spec/blob/master/
     * RNCryptor- Spec-v3.md</a>
     ...
     *
     * @param ciphertext data to decrypt. Must be in the format described at <a href=
     *                   "https://github.com/RNCryptor/RNCryptor-Spec/blob/master/RNCryptor-Spec-v3.md"
     *                   >https://github.com/RNCryptor/RNCryptor-Spec/blob/master/
     *                   RNCryptor -Spec-v3.md</a>
     * @param password   password to use for the decryption. Cannot be empty or
     *                   <code>null</code>.
     * @return the plain text
     */
    byte[] decryptData(byte[] ciphertext, char[] password) throws CryptorException;
     ...
     * @param hmacKey       the key to verify the HMAC with
     * @return the plain text
     */
    byte[] decryptData(byte[] ciphertext, SecretKey decryptionKey, SecretKey hmacKey) throws CryptorException;

    /**
     * Encrypts data with the supplied password.
     *
     * @param plaintext the data to encrypt
     * @param password  password to use for the encryption. Cannot be empty or
     *                  <code>null</code>.
     * @return the ciphertext, in the format described at <a href=
     * "https://github.com/RNCryptor/RNCryptor-Spec/blob/master/RNCryptor-Spec-v3.md"
     * >https://github.com/RNCryptor/RNCryptor-Spec/blob/master/
     ...
     * @param hmacKey       key to use for computing the HMAC
     * @return the ciphertext, in the format described at <a href=
     * "https://github.com/RNCryptor/RNCryptor-Spec/blob/master/RNCryptor-Spec-v3.md"
     * >https://github.com/RNCryptor/RNCryptor-Spec/blob/master/
     * RNCryptor- Spec-v3.md</a>
