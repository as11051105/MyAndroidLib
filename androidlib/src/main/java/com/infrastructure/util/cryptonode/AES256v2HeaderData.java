...
class AES256v2HeaderData {
    ...
    private static final int SIZE_WITH_PASSWORD = AES256v3Ciphertext.HEADER_SIZE + AES256v3Ciphertext.ENCRYPTION_SALT_LENGTH + AES256v3Ciphertext.HMAC_SALT_LENGTH + AES256v3Ciphertext.AES_BLOCK_SIZE;

    private static final int SIZE_WITHOUT_PASSWORD = AES256v3Ciphertext.HEADER_SIZE + AES256v3Ciphertext.AES_BLOCK_SIZE;
    ...
    AES256v2HeaderData(byte[] data) throws InvalidDataException {
        ...
        if (version != AES256v3Ciphertext.EXPECTED_VERSION) {
            throw new InvalidDataException(String.format("Expected version %d but found %d.", AES256v3Ciphertext.EXPECTED_VERSION, version));
        }
        ...
        final int minimumLength = (isPasswordBased) ? SIZE_WITH_PASSWORD : SIZE_WITHOUT_PASSWORD;
    ...
    /**
     * Returns the encryption salt. Will be <code>null</code> if the header is
     * for key-protected data.
     *
