...
public class AES256JNCryptorOutputStream extends OutputStream {
     ...
     *
     * @param out           the {@code OutputStream} to write the JNCryptor data to
    ...
    public AES256JNCryptorOutputStream(OutputStream out, SecretKey encryptionKey, SecretKey hmacKey) throws CryptorException {
        ...
        byte[] iv = AES256JNCryptor.getSecureRandomData(AES256Ciphertext.AES_BLOCK_SIZE);
    ...
    public AES256JNCryptorOutputStream(OutputStream out, char[] password, int iterations) throws CryptorException {
        ...
        encryptionSalt = AES256JNCryptor.getSecureRandomData(AES256JNCryptor.SALT_LENGTH);
     ...
     * @param iv            the IV
     * @param out           the output stream we are wrapping
     */
     ...
     *
     * @param b   a buffer of bytes to write
    ...
    /**
     * An output stream to update a Mac object with all bytes passed through,
     * then write the Mac data to the stream upon close to complete the
     * RNCryptor file format.
     */
