...
import static com.infrastructure.util.ConvertUtils.bytes2HexString;
import static com.infrastructure.util.ConvertUtils.hexString2Bytes;
...
public class EncryptUtils {
    ...
    public String decrypt(String cipherText) {
        try {
            byte[] encrypted1 = android.util.Base64.decode(cipherText, android.util.Base64.NO_WRAP);
            Cipher cipher = Cipher.getInstance("AES/ECB/PKCS5Padding");
            SecretKeySpec keyspec = new SecretKeySpec(key.getBytes(), "AES");
