package com.infrastructure.util.tabindicator;
...
public class TabTitlePageIndicator extends HorizontalScrollView {
    ...
    private int indicatorColor = Color.parseColor("#ffffff");                                        // 指示线的颜色
    // #0075E7
    ...
    public TabTitlePageIndicator(Context context) {
        this(context, null);
        this.mContext = context;
    }

    public TabTitlePageIndicator(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
        this.mContext = context;
    }

    public TabTitlePageIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        // isSameLine = a.getBoolean(R.styleable.PagerSlidingTab_sameLine,
        // isSameLine);
