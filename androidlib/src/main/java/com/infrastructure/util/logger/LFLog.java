package com.infrastructure.util.logger;
...
import com.infrastructure.util.logger.util.MapParser;
import com.infrastructure.util.logger.util.ObjParser;
...
public final class LFLog {
    ...
    private static final int OBJ = 0xF6;
    private static final int MAP = 0xF8;
    ...
    public static class Builder {
        ...
        public Builder setLogSwitch(boolean logSwitch) {
            LFLog.sLogSwitch = logSwitch;
            return this;
        }

        public Builder setGlobalTag(String tag) {
            if (!isSpace(tag)) {
                LFLog.sGlobalTag = tag;
                sTagIsSpace = false;
            } else {
                LFLog.sGlobalTag = "";
                sTagIsSpace = true;
    ...
    public static void map(Map<String, String> map) {
        log(MAP, sGlobalTag, map);
    }

    public static void map(String tag, Map<String, String> map) {
        log(MAP, tag, map);
    }
    ...
    private static String formatObj(Object object) {
        return ObjParser.parseObj(object);
    }

    private static String formatMap(Object object) {
        Map<String, String> map = (Map) object;
        return MapParser.parseMap(map);
    }
