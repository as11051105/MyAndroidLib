package com.infrastructure.widgets.switchView;
...
public class SwitchView extends View {
    private final int DEFAULT_COLOR_PRIMARY = 0xFF12b7f5;
    private final int DEFAULT_COLOR_PRIMARY_DARK = 0xFF12b7f5;
    ...
    public SwitchView(Context context, AttributeSet attrs) {
        ...
        colorPrimary = a.getColor(R.styleable.SwitchView_color, DEFAULT_COLOR_PRIMARY);
        colorPrimaryDark = a.getColor(R.styleable.SwitchView_colorDark, DEFAULT_COLOR_PRIMARY_DARK);
