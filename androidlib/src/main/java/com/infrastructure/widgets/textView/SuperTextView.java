package com.infrastructure.widgets.textView;
...
public class SuperTextView extends RelativeLayout {
    ...
    private TextView rightHotTV;//右边新提示红色图标
     ...
     * 右边新提示红色图标
     */
    private String rightHotNumString;
    ...
    private LayoutParams centerBaseLineParams, topLineParams, bottomLineParams, leftImgParams, leftTextParams,
            centerTextParams, leftTopTextParams, leftBottomParams,
            leftBottomParams2,
            rightTextParams,
            rightTextHotParams,
            rightImgParams, rightCheckBoxParams;
     ...
     * 初始化右边图标
     */
    private void initRightHotIcon() {
        rightHotTV = new TextView(mContext);
        rightTextHotParams = new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
        //  rightTextHotParams.addRule(ALIGN_PARENT_RIGHT, TRUE);
        rightTextHotParams.addRule(RelativeLayout.CENTER_VERTICAL, TRUE);
        rightTextHotParams.addRule(RelativeLayout.LEFT_OF, R.id.sRightIVId);
        setMargin(rightTextHotParams, 0, 0, rightIconMarginRight, 0);
        rightHotTV.setLayoutParams(rightTextHotParams);
        rightHotTV.setBackgroundResource(R.drawable.tip_red_circle);
        rightHotTV.setTextColor(0xffffffff);
        rightHotTV.setTextSize(12);
        if (TextUtils.isEmpty(rightHotNumString)) {
            rightHotTV.setVisibility(View.GONE);
        } else {
            rightHotTV.setVisibility(View.VISIBLE);
            rightHotTV.setText(rightHotNumString + "");
        }

        rightHotTV.setGravity(Gravity.RIGHT);
        rightHotTV.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                if (onSuperTextViewClickListener != null) {
                    onSuperTextViewClickListener.onRightIconIV();
                }
            }
        });
        addView(rightHotTV);
    ...
    private void initRightIcon() {
        ...
        rightIconIV.setId(R.id.sRightIVId);
     ...
     * 设置右边图标
     *
     * @param numString 右边数字
     * @return 返回对象
     */
    public SuperTextView setHotNum(String numString) {
        rightHotNumString = numString;
        if (rightHotTV == null) {
            initRightHotIcon();
        } else {
            if (TextUtils.isEmpty(numString)) {
                rightHotTV.setVisibility(GONE);
            } else {
                rightHotTV.setVisibility(VISIBLE);
                rightHotTV.setText(numString);
            }
        }
        return this;
    }
