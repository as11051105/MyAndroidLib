...
/**
 * 类名: WheelViewDate.java
 * <p>
 * 功能:
 *
 * @author Mr.Z
 * @version 1.0
 * @dateTime 2015-2-9 上午11:24:59
 */
public class WheelViewDate extends View {
    ...
    // Listeners
    private List<OnWheelChangedListenerDate> changingListeners = new LinkedList<OnWheelChangedListenerDate>();
    private List<OnWheelScrollListenerDate> scrollingListeners = new LinkedList<OnWheelScrollListenerDate>();
    private Context context;

    /**
     * Constructor
     */
    public WheelViewDate(Context context, AttributeSet attrs, int defStyle) {
     ...
     * Constructor
     */
    public WheelViewDate(Context context, AttributeSet attrs) {
        super(context, attrs);
        initData(context);
    }
     ...
     */
    public void addChangingListener(OnWheelChangedListenerDate listener) {
     ...
     * @param listener the listener
     */
    public void removeChangingListener(OnWheelChangedListenerDate listener) {
    ...
    protected void notifyChangingListeners(int oldValue, int newValue) {
        for (OnWheelChangedListenerDate listener : changingListeners) {
     ...
     * @param listener the listener
     */
    public void addScrollingListener(OnWheelScrollListenerDate listener) {
     ...
     * @param listener the listener
     */
    public void removeScrollingListener(OnWheelScrollListenerDate listener) {
    ...
    protected void notifyScrollingListenersAboutStart() {
        for (OnWheelScrollListenerDate listener : scrollingListeners) {
