...
public class LayoutRippleRound extends CustomViewRound {
    ...
    public LayoutRippleRound(Context context, AttributeSet attrs) {
        super(context, attrs);
        setAttributes(attrs);
    }
    ...
    protected void setAttributes(AttributeSet attrs) {
        ...
        rippleSpeed = attrs.getAttributeFloatValue(MATERIALDESIGNXML, "rippleSpeed", 20f);
    }
