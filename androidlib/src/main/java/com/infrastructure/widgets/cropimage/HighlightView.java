 ...
 */
package com.infrastructure.widgets.cropimage;
...
public class HighlightView {
     ...
     * The m draw rect.
     */
    public Rect mDrawRect;                                    // in
    // screen
    /**
     * The m image rect.
     */
    public RectF mImageRect;                                    // in
    // image
    /**
     * The m crop rect.
     */
    public RectF mCropRect;                                    // in
    // image
    /**
     * The m matrix.
     */
     ...
     */
    private void init() {
        mResizeDrawableDiagonal = ImageUtil.bitmapToDrawable(ImageUtil.getBitmapFromSrc("image/crop_big.png"));
        mResizeDrawableDiagonal2 = ImageUtil.bitmapToDrawable(ImageUtil.getBitmapFromSrc("image/crop_small.png"));
    }
    ...
    public void draw(Canvas canvas) {
        ...
        if (!hasFocus()) {
            ...
            if (mCircle) {
                ...
                int widthWidth = mResizeDrawableDiagonal.getIntrinsicWidth();
                int widthHeight = mResizeDrawableDiagonal.getIntrinsicHeight();
