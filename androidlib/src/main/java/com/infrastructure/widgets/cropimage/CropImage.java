...
public class CropImage {
    ...
    Runnable mRunFaceDetection = new Runnable() {
        ...
        // Create a default
        // HightlightView if we
        // found no face in the
        // picture.
     ...
     */
    public CropImage(Context context, String cachePath, CropImageView imageView, Handler handler) {
        mContext = context;
        mImageView = imageView;
        mImageView.setCropImage(this);
        mHandler = handler;
        // 初始化图片保存路径
        FILE_LOCAL = new File(cachePath);
