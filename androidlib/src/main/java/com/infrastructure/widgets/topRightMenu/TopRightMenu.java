package com.infrastructure.widgets.topRightMenu;
    ...
    private PopupWindow getPopupWindow() {
        ...
        mPopupWindow.setOnDismissListener(new PopupWindow.OnDismissListener() {
            ...
            public void onDismiss() {
                onMenuDismissClickListener.onMenuDismissClickListener();
                if (dimBackground) {
...
//    }
    ...
    public TopRightMenu setOnMenuDismissClickListener(OnMenuDismissClickListener listener) {
        onMenuDismissClickListener = listener;
        return this;
    }
    ...
    public interface OnMenuDismissClickListener {
        void onMenuDismissClickListener();
    }

    private TopRightMenu.OnMenuDismissClickListener onMenuDismissClickListener;
