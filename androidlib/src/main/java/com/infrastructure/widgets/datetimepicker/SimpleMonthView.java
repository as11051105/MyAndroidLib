package com.infrastructure.widgets.datetimepicker;
...
public class SimpleMonthView extends View {
    ...
    public SimpleMonthView(Context context) {
        ...
        this.mTodayNumberColor = ContextCompat.getColor(context, R.color.blue);
        this.mMonthTitleColor = ContextCompat.getColor(context, R.color.white);
        this.mMonthTitleBGColor = ContextCompat.getColor(context, R.color.circle_background);
    ...
    private void drawMonthDayLabels(Canvas canvas) {
        ...
        for (int day = 0; day < this.mNumDays; day++) {
            ...
            canvas.drawText(
                    mDateFormatSymbols.getShortWeekdays()[this.mDayLabelCalendar.get(Calendar.DAY_OF_WEEK)].toUpperCase(Locale.getDefault()), x,
                    y, this.mMonthDayLabelPaint);
        }
    }
    ...
    public SimpleMonthAdapter.CalendarDay getDayFromLocation(float x, float y) {
        ...
        int day = 1 + ((int) ((x - padding) * this.mNumDays / (this.mWidth - padding - this.mPadding)) - findDayOffset()) +
                yDay * this.mNumDays;
