package com.infrastructure.widgets.recyclerView.universaladapter;
...
public class ViewHolderHelper extends RecyclerView.ViewHolder {
    ...
    public ViewHolderHelper setImageBackgroundResource(int viewId, int resId) {
    ...
    public ViewHolderHelper setImageUrl(int viewId, String url) {
        ImageView view = getView(viewId);
        ImageLoaderUtils.loadImg(mContext, url, view);
        return this;
    }
    ...
    public ViewHolderHelper setImageRoundUrl(int viewId, String url) {
        ImageView view = getView(viewId);
        ImageLoaderUtils.loadRoundImg(mContext, url, view);
        return this;
    }

    public ViewHolderHelper setImageUrl(int viewId, String url, int defaultId) {
        ImageView view = getView(viewId);
        ImageLoaderUtils.loadImg(mContext, url, defaultId, view);
        return this;
    }
    public ViewHolderHelper setImageGlideUrl(int viewId, String url, int defaultId) {
        ImageView view = getView(viewId);
        ImageLoaderUtils.loadRoundImg(mContext, url, defaultId, view);
        return this;
    }
